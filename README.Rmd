...
We also provide an [environment file](https://github.com/aerickso/SpatialInferCNV/blob/main/environment.yml) to set up a conda environment with all the dependencies necessary for SpatialInferCNV. If you have anaconda installed, you can create a new environment and activate it by running the code below.
