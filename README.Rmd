...
A [environment.yml](https://github.com/aerickso/SpatialInferCNV/blob/main/environment.yml) file is available for those wishing to work in a conda environent.
...
The package provides a number of functions, please read the function documentation in each function located [here](https://github.com/aerickso/SpatialInferCNV/blob/main/UserGuide/UserGuideDraft.md).
