...
![](./Images/Prostate.png){width=75%} 

![](./Images/H2_1_HistologicalAnnotations_LoupeBrowser.png){width=75%}

![](./Images/infercnv.21_denoised.png){width=75%}

![](./Images/H2_1_Clones_LoupeBrowser.png){width=75%}
...
![](./Data/InferCNV Files/ExampleOutputs/Unsupervised/infercnv.21_denoised.png)
...
![](./Images/Consensus_H2_1_forclustering_phylo_09032021.png){width=75%}
...
![](./Images/NodeSelectionFromDenoised_19032021.png){width=75%}

![](./Images/NodeSelectionDendrogram_19032021.png){width=75%}
...
![](./Data/InferCNV Files/ExampleOutputs/Supervised/infercnv.21_denoised.png) 

![](./Data/InferCNV Files/ExampleOutputs/Supervised/infercnv.17_HMM_predHMMi6.hmm_mode-samples.png)        
# Clone Tree Building
