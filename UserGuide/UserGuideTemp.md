...
------------------------------------------------------------------------
SpatialInferCNV (**Spatial** **Infer** genome-wide **C**opy-**N**umber **V**ariations(CNV)) is a programme to analyse the spatially resloved transcriptomics
to infer spatial copy number variation in different regions across multiple organs in benigh and malignant tissues.
