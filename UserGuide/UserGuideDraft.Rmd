...
ggsave(paste0("BC23209_C1", "_", "PGA_SpatialVisualization_", Sys.Date(), ".png"),
         ...
         limitsize = TRUE)
```
The spots should be now visualized with the clone identity labeled. Remember that we are using data from <10 spots, so the majority of the image should be grey.
