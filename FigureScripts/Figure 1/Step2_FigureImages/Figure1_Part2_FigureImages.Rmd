...
Here is an ![example output for section H2_5](https://github.com/aerickso/SpatialInferCNV/blob/main/FigureScripts/Figure%201/Step2_FigureImages/H2_5_Revised_PGA_SpatialVisualization_2022-02-28.png).
...
Finally, we visualize the ![Barplot in Figure 1G](https://github.com/aerickso/SpatialInferCNV/blob/main/FigureScripts/Figure%201/Step2_FigureImages/siCNV_SectionBarPlot_Figure1G.png).
